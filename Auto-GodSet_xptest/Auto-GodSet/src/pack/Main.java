...
public class Main {
	...
	public void compute(String xItem, boolean rSet, String rName, ArrayList compute, ArrayList<Integer> cust) {
		...
		System.out.println("Your total xp cost is: " + xp);
		end(rSet, rName);
	}
	...
	public void end(boolean isSet, String isName) {
		System.out.println();
		System.out.println("Type 'Export' to export to your list. Otherwise type 'Stop' or anything else to exit.");
